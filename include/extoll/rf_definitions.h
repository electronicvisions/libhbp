...
//! \brief //!
Read-write Jtag register Reset at address 0x0;
//! Fields:
//! core : 1
//! hicann : 1
//! arq : 1
...
//! \brief //!
Read-write Jtag register JtagCmd at address 0x400;
//! Fields:
//! type : 3
//! length : 10
//! pause : 1
...
//! \brief Read-only Jtag register JtagStatus at address 0x408;
//! Fields:
//! clock_enabled : 1
//! paused : 1
struct JtagStatus
...
//! \brief //!
Read-write Jtag register JtagSend at address 0x480;
//! Fields:
//! data : 64
struct JtagSend
{
...
//! \brief Read-only Jtag register JtagReceive at address 0x500;
//! Fields:
//! data : 64
struct JtagReceive
{
...
//! \brief Read-only Jtag register HicannIfState at address 0x800;
//! Fields:
//! channel_status : 8
//! crc_count : 8
//! systime : 14
...
//! \brief Read-only Jtag register HicannIfRxConfig at address 0x808;
//! Fields:
//! data : 64
...
//! \brief Read-only Jtag register HicannIfRxPulse at address 0x810;
//! Fields:
//! data : 24
...
//! \brief //!
Read-write Jtag register HicannIfConfig at address 0x818;
//! Fields:
//! start_link : 1
//! loopback_enable : 1
//! auto_init : 1
...
//! \brief Write-only Jtag register HicannIfControls at address 0x820;
//! Fields:
...
//! \brief //!
Read-write Jtag register HicannIfTxData at address 0x828;
//! Fields:
//! data : 64
...
//! \brief //!
Read-write Jtag register HicannPacketGen at address 0x830;
//! Fields:
//! count : 25
//! error : 1
//! enable : 1
...
//! \brief //!
Read-write Jtag register HicannChannel at address 0x838;
//! Fields:
//! number : 3
...
//! \brief //!
Read-write Jtag register ArqTimings at address 0x840;
//! Fields:
//! master_timeout : 10
//! target_timeout : 10
//! arbiter_delay : 5
...
//! \brief //!
Read-write Jtag register TestControlEnable at address 0xc00;
//! Fields:
//! enable : 1
...
//! \brief //!
Read-write Jtag register TestControlConfig at address 0xc08;
//! Fields:
//! quad_words : 8
//! pause_time : 8
//! count_up : 1
...
//! \brief //!
Read-write Jtag register TestControlStart at address 0xc10;
//! Fields:
//! start : 1
...
//! \brief //!
Read-write Jtag register TestControlData at address 0xc18;
//! Fields:
//! data : 64
...
//! \brief //!
Read-write Jtag register TestControlType at address 0xc20;
//! Fields:
//! type : 16
...
//! \brief //!
Read-write Jtag register TraceBufferStart at address 0x1000;
//! Fields:
//! data : 64
...
//! \brief //!
Read-write Jtag register TraceBufferSize at address 0x1008;
//! Fields:
//! data : 32
...
//! \brief //!
Read-write Jtag register TraceBufferFullThreshold at address 0x1010;
//! Fields:
//! data : 32
...
//! \brief Read-only Jtag register TraceBufferCounter at address 0x1018;
//! Fields:
//! start_address : 16
//! size : 16
//! threshold : 16
...
//! \brief Write-only Jtag register TraceBufferCounterReset at address 0x1020;
//! Fields:
//! reset : 1
...
//! \brief Read-only Jtag register TraceBufferCurrentAddress at address 0x1028;
//! Fields:
//! data : 64
...
//! \brief Read-only Jtag register TraceBufferEndAddress at address 0x1030;
//! Fields:
//! data : 64
...
//! \brief Read-only Jtag register TraceBufferFreeSpace at address 0x1038;
//! Fields:
//! data : 32
...
//! \brief //!
Read-write Jtag register TraceBufferInit at address 0x1040;
//! Fields:
//! start : 1
...
//! \brief //!
Read-write Jtag register HicannBufferStart at address 0x1080;
//! Fields:
//! data : 64
...
//! \brief //!
Read-write Jtag register HicannBufferSize at address 0x1088;
//! Fields:
//! data : 32
...
//! \brief //!
Read-write Jtag register HicannBufferFullThreshold at address 0x1090;
//! Fields:
//! data : 32
...
//! \brief Read-only Jtag register HicannBufferCounter at address 0x1098;
//! Fields:
//! start_address : 16
//! size : 16
//! threshold : 16
...
//! \brief Write-only Jtag register HicannBufferCounterReset at address 0x10a0;
//! Fields:
//! reset : 1
...
//! \brief Read-only Jtag register HicannBufferCurrentAddress at address 0x10a8;
//! Fields:
//! data : 64
...
//! \brief Read-only Jtag register HicannBufferEndAddress at address 0x10b0;
//! Fields:
//! data : 64
...
//! \brief Read-only Jtag register HicannBufferFreeSpace at address 0x10b8;
//! Fields:
//! data : 32
...
//! \brief //!
Read-write Jtag register HicannBufferInit at address 0x10c0;
//! Fields:
//! start : 1
...
//! \brief Read-only Jtag register RraPutReceived at address 0x1100;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register RraGetReceived at address 0x1108;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register RmaPutReceived at address 0x1110;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register RmaNotificationReceived at address 0x1118;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register PlaybackReceived at address 0x1120;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register FpgaConfigReceived at address 0x1128;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register HicannConfigReceived at address 0x1130;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register JtagDataReceived at address 0x1138;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register NeighbourDataReceived at address 0x1140;
//! Fields:
//! count : 48
...
//! \brief Write-only Jtag register CounterReset at address 0x1148;
//! Fields:
//! reset : 1
struct CounterReset
{
...
//! \brief Read-only Jtag register InvalidCommand at address 0x1150;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register InvalidType at address 0x1158;
//! Fields:
//! count : 48
struct InvalidType
{
...
//! \brief Read-only Jtag register InvalidPayloadSize at address 0x1160;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register InvalidFields at address 0x1168;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register InvalidMode at address 0x1170;
//! Fields:
//! count : 48
struct InvalidMode
{
...
//! \brief Read-only Jtag register InvalidRraAddress at address 0x1178;
//! Fields:
//! count : 48
...
//! \brief Read-only Jtag register InvalidHost at address 0x1180;
//! Fields:
//! count : 48
struct InvalidHost
{
...
//! \brief Read-only Jtag register ConfigAddressReinit at address 0x1188;
//! Fields:
//! count : 48
...
//! \brief //!
Read-write Jtag register HostEndpoint at address 0x1190;
//! Fields:
//! node_id : 16
...
//! \brief //!
Read-write Jtag register ConfigResponse at address 0x1198;
//! Fields:
//! address : 64
...
//! \brief //!
Read-write Jtag register TraceNotificationBehaviour at address 0x11a0;
//! Fields:
//! timeout : 32
//! frequency : 32
...
//! \brief //!
Read-write Jtag register HicannNotificationBehaviour at address 0x11a8;
//! Fields:
//! timeout : 32
//! frequency : 32
...
//! \brief Read-only Jtag register Driver at address 0x8000;
//! Fields:
//! version : 64
struct Driver
{
...
//! \brief Read-only Jtag register Info at address 0x8008;
//! Fields:
//! guid : 24
//! node_id : 16
struct Info
