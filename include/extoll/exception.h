...
//! driver. This can occur if two many regions are already registered with the driver
...
//! \brief This exception indicates that the user tried to receive a Hicann config packet when
//! nothing was sent.
//!
...
//! This exception occurs when the user tries to connect to a remote node that is not an HBP
//! communication Fpga
...
//! This exception occurs when the user creates a JTag access object although the remote Fpga is not
//! connected to any Hicann
