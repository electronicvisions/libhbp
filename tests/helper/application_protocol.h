...
void highspeed_init(extoll::library::RegisterFile& rf, extoll::library::JTag& jtag, extoll::library::Fpga& fpga, uint8_t hicann);
...
HsStatus highspeed_status(extoll::library::RegisterFile& rf, extoll::library::JTag& jtag, uint8_t hicann);
