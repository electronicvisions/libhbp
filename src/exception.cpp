...
NodeHasNoHicann::NodeHasNoHicann(RMA2_Nodeid n) :
    ConnectionFailed("Connection to HICANN failed, because node has no HICANNs"), node(n)
{}
...
HicannResponseTimedOut::HicannResponseTimedOut() : RmaError("Hicann response timed out") {}
